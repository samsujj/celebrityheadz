...
app.post('/newcontact1',function(req,resp){
    ...
    var mail = {
        ...
        to: "1wmbxx@gmail.com",
        subject: "New Contact Form Submission by "+req.body.fullname+" on celebrityheadz.com",
        //text: "Node.js New world for me",
...
app.post('/signupinsert',function(req,resp){
    ...
    var mail = {
        ...
        to: "1wmbxx@gmail.com",
        subject: "New Enquiry Form Submission by "+req.body.fname+" on celebrityheadz.com",
        //text: "Node.js New world for me",
        html: "<b>Name</b> :   "+req.body.fname +" "+req.body.lname+"<br><b>Email</b> :   "+req.body.email+ "<br><b>Phone Number</b> :   "+req.body.phone_no +"<br><b>Industry</b> :   "+req.body.industry +"<br><b>Others</b> :   "+req.body.others +"<br><b>Any more information</b> :   "+req.body.more_information,
    }
